...
# Constants
p = 0.8      # probability of getting a '1'
N = 5
n2 = 2**N
nd = 1. / N
...
pl.plot([xmax + (1.-xmax)*.16,r[0,3]], [0,r[0,6]])
for i in range(0,n2-1):
    pl.plot([r[i,3],r[i,3]],   [r[i,6],   r[i+1,6]], color='m')
    pl.plot([r[i,3],r[i+1,3]], [r[i+1,6], r[i+1,6]], color='m')
pl.plot([r[i+1,3],0], [1,1], color = 'm')
...
pl.ylabel('1/N H_delta(X^N)')
pl.xlabel('delta')
pl.title('Essential Bit Content / Lengh of String')
